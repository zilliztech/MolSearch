var JSUnits = {
	...
	embed: {
		src: ["src/js/Loader.Embed.js", "src/js/MolView.Embed.js"],
	},
};
	...
	grunt.initConfig({
		...
		uglify: {
			base: {
				options: {
					banner:
						'/*! MolView JavaScript Base libraries build on <%= grunt.template.today("yyyy-mm-dd") %> */\n',
			...
			applib: {
				options: {
					banner:
						'/*! MolView JavaScript App libraries build on <%= grunt.template.today("yyyy-mm-dd") %> */\n',
					compress: { drop_console: true },
				},
			...
			datasets: {
				options: {
					banner:
						'/*! MolView JavaScript Datasets build on <%= grunt.template.today("yyyy-mm-dd") %> */\n',
				},
			...
			core: {
				options: {
					banner:
						'/*! MolView JavaScript Core build on <%= grunt.template.today("yyyy-mm-dd") %> */\n',
				},
			...
			molpad: {
				options: {
					banner:
						'/*! MolView JavaScript Sketcher build on <%= grunt.template.today("yyyy-mm-dd") %> */\n',
				},
			...
			app: {
				options: {
					banner:
						'/*! MolView JavaScript App build on <%= grunt.template.today("yyyy-mm-dd") %> */\n',
				},
				src: JSUnits.app.src,
			...
			embed: {
				options: {
					banner:
						'/*! MolView JavaScript Embed build on <%= grunt.template.today("yyyy-mm-dd") %> */\n',
				},
		...
		less: {
			...
			page: {
				...
				src: ["src/less/vars.less", "src/less/page.less"],
		...
		copy: {
			img: {
				files: [
					...
					{ src: "src/svg/icon/github.svg", dest: "img/github.svg" },
					{ src: "src/svg/icon/slack.svg", dest: "img/slack.svg" },
		...
		watch: {
			...
			base: {
				files: JSUnits.base.src,
				tasks: ["uglify:base", "replace:strict"],
			},
